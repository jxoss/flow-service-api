...
exports.create = function (options, data, next) {
    ...
    _checkRequired(data, 
        ...
        options._Service.User.create(userDocument, function (err, result) {
            ...
            var activationUrl = 'https://' + options.socket.upgradeReq.headers.host + '/flow/service_api: '
...
exports.sendEmailRecovery = function (options, data, next) {
    ...
    _checkRequired(data, 
        ...
        options._Service.User.get( 
            ...
            var recoveryUrl = 'https://' + options.socket.upgradeReq.headers.host + '/flow/service_api:recoverEmail'
