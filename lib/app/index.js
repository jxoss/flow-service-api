...
/**
 * get
 * Returns a app in jsonld compact form
 *
 * @name get
 * @function
 * @param {Object} options Object containig data handler options
...
exports.get = function (options, data, next) {
    ...
    // call service-api
    options._Service.App.get(data.id, next);
};
...
exports.list = function (options, data, next) {
    ...
    _checkRequired(data, 
        ...
        // call service-api
        options._Service.App.list(user, data.project, {}, next);
    });
};
